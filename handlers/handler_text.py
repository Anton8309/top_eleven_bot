class HandlerText:
    ...
    HELP: str = ('<b>Как пользоваться ботом!</b>''\n''\n'
                 '<b>Выбираем кнопку GK</b> - в ней есть две кнопки,\n'
                 '<b>навыки</b> и <b>тренировка</b>.''\n'
                 'Нам нужна кнопка тренировка.''\n'
                 'В кнопке тренировка мы видим <b>(УПРАЖНЕНИЯ)</b>!''\n'
                 '\t⚽ <b>Тренировка вратаря - 6упр.</b>''\n'
                 '\t⚽ <b>Заходим в игру</b>, и выбираем из списка состава''\n'
                 '\tнеобходимого нам по позиции игрока <b>(голкипера)</b>,''\n'
                 '\tназначаем ему упражнения <b>(тренировка вратаря)</b>''\n'
                 '\tи ставим ему <b>6 упражнений</b>.''\n'
                 ...
                 '<b>Если игрок оказался талантливым</b>, то всех процентных показатели достигнет быстро,''\n'
