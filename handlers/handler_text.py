class HandlerText:
    ...
    HELP: str = ('Как пользоваться ботом!''\n''\n'
                 ...
                 '\t⚽ Заходим в игру, и выбираем из списка состава''\n'
                 '\tнеобходимого нам по позиции игрока (голкипера),''\n'
                 '\tназначаем ему упражнения (тренировка вратаря)''\n'
                 '\tи ставим ему 6 упражнений.''\n'
                 '\t⚽ Проводим тренировку до тех пор, пока мы не''\n'
                 '\tполучим результат средний по проценту,''\n'
                 '\tа именно должно получиться так.''\n'
                 '\t(Защита ворот сред.,(105%))''\n'
                 '\t(Психофизика сред.,(51%))''\n'
                 '\t⚽ Далее все делаем по порядку как у казано в боте,''\n'
                 '\tвыбираем следующие упражнение под номером 2''\n'
                 'и проводим тренировку игрока до тех процентных показателей,'
                 'как показано во втором упражнении.''\n'
                 'Так выполняем все 9 упражнений.''\n'
                 'В итоге у нас выходит довольно неплохой игрок.''\n'
                 'Приблизительная затрата игровых ресурсов составит от 300 до 500 аптек.''\n'
                 'Если игрок оказался талантливым, то всех процентных показателей достигнет быстро,''\n'
                 'и затраты могут быть ниже, приблизительно 300-350 игровых ресурсов.''\n'
                 '\t⚽ Качать игроков необходимо от 3-х звезд, от 40% и с возрастом от 18 до 20 лет.')
