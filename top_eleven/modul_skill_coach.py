...
def coaching_dc(self):
    coach_dc = {
        ...
        'УПРАЖНЕНИЯ': ['[1]Прессинг-6упр.,\n'
                       ...
                       '[a](Защита сред.,(139%))\n'
                       '[b](Психофизика сред.,(116%))''\n'
                       '---------------------------------\n'
                       '[7]Техника ударов-6упр.,\n'
                       '[a](Защита сред.,(139%))\n'
                       '[b](Психофизика сред.,(119%))''\n'
                       '----------------------------------\n'
                       '[8]Тренировка техники-4упр.,''\n'
                       'стандарты-2упр.,\n'
                       '[a](Защита сред.,(145%))\n'
...
def coaching_aml_amr(self):
    coach_aml_amr = {
        ...
        'УПРАЖНЕНИЯ': ['[1]Тренировка техники-2упр.,''\n'
